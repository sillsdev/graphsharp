...
namespace GraphSharp.Algorithms.Layout.Simple.FDP
{
        ...
        where TGraph : IBidirectionalGraph<TVertex, TEdge>
    {
        ...
        public StressMajorizationLayoutAlgorithm(TGraph visitedGraph, IDictionary<TVertex, Point> vertexPositions, StressMajorizationLayoutParameters oldParameters)
